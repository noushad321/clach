...
<main id="main" class="main gutter--small-up-normal" role="main">
    <div id="checkout-main" class="checkout max-width--xmedium" data-customer-type="guest" data-stage="" data-current-stage="shipping" data-checkout-get-url="" data-shipping-view="single">
        <div class="row">
            @if(session('cart'))
            <div class="col-12 col-md-7">
                <div class="gutter--normal">
                    <div class="checkout-steps-header extend-gutter--small-up-normal">
                        <div class="checkout-steps-header__item mt-4" data-checkout-component="steps-header-shipping" tabindex="-1">
                            ...
                            <div class="checkout-steps-header__message checkout-stage__shaded-message gutter--normal bg--grey-1">
                                <form class="checkout-stage__form toggle--active" autocomplete="on" method="POST" novalidate="" action="{{ route('shipment') }}" data-address-mode="new" data-checkout-component="single-shipping-form" name="dwfrm_shipping" id="dwfrm_shipping">
                                    @csrf
                                    ...
                                    required dwfrm_shipping_shippingAddress_contactInfoFields_email" data-floating-label="">
                                                    ...
                                                    <input type="email" required="" class="form-control email" id="email" value="" aria-describedby="emailInvalidMessage" name="shipping_email" aria-required="true" maxlength="50" pattern="^[\w.!#$%\/'*+=?^`{|}~-]+@[\w.-]+\.[\w]{2,6}$">
                                            ...
                                            <li class="col-12 col-lg-6 checkout-steps_list-login">
                                                ...
                                                <div class="opt-wrapper">
                                                    <div class="checkout-register">
                                                        <a class="checkout-steps-header__message-link font-family--serif link--secondary" title="Register" href="/register" data-auth-required="true">Register</a>
                                                    </div>
                                                    <div class="checkout-login">
                                                        <a class="checkout-steps-header__message-link font-family--serif link--secondary" title="Login" href="/login" data-auth-required="true">Login</a>
                                                    </div>
                                                </div>
                                            </li>
                                        </ul>
                                                ...
                                                <fieldset class="checkout-stage__details-section" data-checkout-component="shipping-address-section">
                                                    <div class="checkout-stage__address-selection checkout-stage__address-selection--top-spacing hidden ">
                                                        <div class="form-group--no-spacing">
                                                            ...
                                                            <select id="shipmentSelector-e0002f69e8fac8fcfd190b30a7" name="shipmentSelector" class="addressSelector form-control form-control--select form-control--boxed form-control--alt-font" data-checkout-component="single-shipping-address-selector" data-create-shipment-url="" aria-describedby="shipmentSelector-1413098612274">
                                                            ...
                                                            <div id="shipmentSelector-1413098612274" class="invalid-feedback"></div>
                                                        </div>

                                                        <div class="checkout-stage__address-actions" data-checkout-component="address-actions">
                                                            <button type="button" class="checkout-stage__address-action link--primary" data-checkout-component="address-action-update">
                                                                Update Address
                                                            </button>


                                                            <button type="button" class="checkout-stage__address-action link--primary" data-checkout-component="address-action-new">
                                                                Add New
                                                            </button>
                                                        ...
                                                        <div class="form-group required">
                                                            ...
                                                            <div class="form-check-group flex">
                                                                ...
                                                                <div class="form-check form-check-group__item">
                                                                    <input id="customerSalutationOption-dwfrm_shipping_shippingAddress_addressFields_salutations_salutation-mr" type="checkbox" class="form-check-input" name="dwfrm_shipping_shippingAddress_addressFields_salutations_salutation" required="" aria-required="true" value="mr" aria-describedby="customerSalutationFeedback">

                                                                    <label for="customerSalutationOption-dwfrm_shipping_shippingAddress_addressFields_salutations_salutation-mr" class="form-check-label">
                                                                        MR
                                                                    </label>
                                                                </div>
                                                                ...
                                                                <div class="form-check form-check-group__item">
                                                                    <input id="customerSalutationOption-dwfrm_shipping_shippingAddress_addressFields_salutations_salutation-mrs" type="checkbox" class="form-check-input" name="dwfrm_shipping_shippingAddress_addressFields_salutations_salutation" required="" aria-required="true" value="mrs" aria-describedby="customerSalutationFeedback">

                                                                    <label for="customerSalutationOption-dwfrm_shipping_shippingAddress_addressFields_salutations_salutation-mrs" class="form-check-label">
                                                                        MRS
                                                                    </label>
                                                                </div>
            ...
            dwfrm_shipping_shippingAddress_addressFields_firstName" data-floating-label="">
                                                                    ...
                                                                    <input type="text" class="form-control shippingFirstName" id="shippingFirstName" data-validate-latin="" value="" name="user_first_name" required="" aria-required="true" maxlength="27" autocomplete="given-name" aria-describedby="dwfrm_shipping_shippingAddress_addressFields_firstName-1103657993110">
                                                                    <div class="invalid-feedback"></div>
                                                                    <div id="dwfrm_shipping_shippingAddress_addressFields_firstName-1103657993110" class="invalid-feedback"></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group
            ...
            dwfrm_shipping_shippingAddress_addressFields_lastName" data-floating-label="">
                                                                    ...
                                                                    <input type="text" class="form-control shippingLastName" id="shippingLastName" data-validate-latin="" value="" name="user_last_name" required="" aria-required="true" maxlength="32" autocomplete="family-name" aria-describedby="dwfrm_shipping_shippingAddress_addressFields_lastName-111923446893">
                                                                    <div class="invalid-feedback"></div>
                                                                    <div id="dwfrm_shipping_shippingAddress_addressFields_lastName-111923446893" class="invalid-feedback"></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group
            ...
            dwfrm_shipping_shippingAddress_addressFields_address1" data-floating-label="">
                                                                    ...
                                                                    <input type="text" class="form-control shippingAddressOne pac-target-input" id="shippingAddressOne" data-validate-alphanumeric="" data-validate-max="60" data-checkout-component="shipping-method-update" data-address-component="address1" placeholder="Type your shipping address" value="" name="first_address" required="" aria-required="true" maxlength="60" autocomplete="off" aria-describedby="dwfrm_shipping_shippingAddress_addressFields_address1-1014696669245">
                                                                    <div class="invalid-feedback"></div>
        ...
        <svg aria-hidden="true" focusable="false" class="tooltip__trigger-icon icon"><use
                xlink:href="#icon--info"></use></svg>
                                                                    ...
                                                                    <div id="dwfrm_shipping_shippingAddress_addressFields_address1-1014696669245" class="invalid-feedback"></div>
                                                                </div>
                                                            </div>
                                                        </div>
            ...
            dwfrm_shipping_shippingAddress_addressFields_address2" data-floating-label="">
                                                                    ...
                                                                    <input type="text" class="form-control shippingAddressTwo" id="shippingAddressTwo" data-validate-alphanumeric="" data-validate-max="39" value="" name="second_address" maxlength="39" autocomplete="shipping address-line2" aria-describedby="dwfrm_shipping_shippingAddress_addressFields_address2-1163134638722">
                                                                    <div class="invalid-feedback"></div>
                                                                    <div id="dwfrm_shipping_shippingAddress_addressFields_address2-1163134638722" class="invalid-feedback"></div>
                                                                </div>
                                                            </div>
            ...
            dwfrm_shipping_shippingAddress_addressFields_city_cityCode" data-floating-label="" data-custom-select="">
                                                                    ...
                                                                    <select class="form-control form-control--select shippingAddressCity select2-hidden-accessible" id="shippingAddressCity" data-checkout-component="shipping-method-update" name="area" required="" aria-required="true" autocomplete="shipping address-level2" aria-describedby="dwfrm_shipping_shippingAddress_addressFields_city_cityCode-1640922866346" data-select2-id="shippingAddressCity" tabindex="-1" aria-hidden="true">
                                                                        ...
                                                                        <option value="Dubai Cars And Auto Zone">
                                                                        ...
                                                                        <option value="Dubai International Financial Center">
                                                                        ...
                                                                        <option value="Dubai Metal And Commodity Center">
                                                                            Dubai Metal And Commodity Center
                                                                        </option>

                                                                        <option value="Dubai Metal And Commodity City">
                                                                        ...
                                                                        <option value="Dubai World Central (DWC)">
                                                                            Dubai World Central (DWC)
                                                                        </option>

                                                                        <option value="Dubai World Trade Centre">
                                                                        ...
                                                                        <option value="Hamriya Phase One Sharjah">
                                                                            Hamriya Phase One Sharjah
                                                                        </option>

                                                                        <option value="Hamriya Phase Two Sharjah">
                                                                        ...
                                                                        <option value="Sharjah Indl Area Eighteen">
                                                                            Sharjah Indl Area Eighteen
                                                                        </option>

                                                                        <option value="Sharjah Indl Area Eleven">
                                                                            Sharjah Indl Area Eleven
                                                                        </option>

                                                                        <option value="Sharjah Indl Area Fifteen">
                                                                        ...
                                                                        <option value="Sharjah Indl Area Fourteen">
                                                                        ...
                                                                        <option value="Sharjah Indl Area Seventeen">
                                                                        ...
                                                                        <option value="Sharjah Indl Area Sixteen">
                                                                        ...
                                                                        <option value="Sharjah Indl Area Thirteen">
                                                                        ...
                                                                        <option value="Sharjah Indl Area Twelve">
                                                                    ...
                                                                    <div class="invalid-feedback"></div>
                                                                    <div id="dwfrm_shipping_shippingAddress_addressFields_city_cityCode-1640922866346" class="invalid-feedback"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group required dwfrm_shipping_shippingAddress_addressFields_country_countryCode set--floating-label" data-floating-label="">
                                                                    ...
                                                                    <select class="form-control shippingCountry custom-select" id="shippingCountry" data-checkout-component="shipping-method-update" name="country_code" required="" aria-required="true" autocomplete="shipping country" aria-describedby="dwfrm_shipping_shippingAddress_addressFields_country_countryCode-291660805933">
                                                                    ...
                                                                    <div id="dwfrm_shipping_shippingAddress_addressFields_country_countryCode-291660805933" class="invalid-feedback"></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-12">
                                                                <div class="form-group required dwfrm_shipping_shippingAddress_addressFields_country_countryCode set--floating-label" data-floating-label="">
            ...
            dwfrm_shipping_shippingAddress_addressFields_states_stateCode" data-floating-label="" data-custom-select="">
                                                                    ...
                                                                    <select class="form-control shippingState custom-select select2-hidden-accessible" id="shippingState" data-checkout-component="shipping-method-update" name="city_code" required="" aria-required="true" autocomplete="shipping address-level1" data-autocomplete-custom="" aria-describedby="dwfrm_shipping_shippingAddress_addressFields_states_stateCode-43096523279" data-select2-id="shippingState" tabindex="-1" aria-hidden="true">
                                                                    ...
                                                                    <div class="invalid-feedback"></div>
                                                                    <div id="dwfrm_shipping_shippingAddress_addressFields_states_stateCode-43096523279" class="invalid-feedback"></div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div id="dwfrm_shipping_shippingAddress_contactInfoFields_email-1620356253012" class="invalid-feedback"></div>
                                                        </div>
        ...
        required" data-floating-label="">
                                                                    ...
                                                                    <div class="iti iti--allow-dropdown iti--separate-dial-code">
                                                                        <div class="iti__flag-container">
                                                                            <div class="iti__selected-flag" role="combobox" aria-controls="iti-0__country-listbox" aria-owns="iti-0__country-listbox" aria-expanded="false" tabindex="0" title="United Arab Emirates (&#x202B;الإمارات العربية المتحدة&#x202C;&lrm;): +971" aria-activedescendant="iti-0__item-ae-preferred">
                                                                            ...
                                                                            <ul class="iti__country-list iti__hide" id="iti-0__country-listbox" role="listbox" aria-label="List of countries">
                                                                                <li class="iti__country iti__preferred iti__active" tabindex="-1" id="iti-0__item-ae-preferred" role="option" data-dial-code="971" data-country-code="ae" aria-selected="true">
                                                                                    <div class="iti__flag-box">
                                                                                        <div class="iti__flag iti__ae"></div>
                                                                                    </div>
                                                                                    <span class="iti__country-name">United Arab Emirates (&#x202B;الإمارات العربية المتحدة&#x202C;&lrm;)</span><span class="iti__dial-code">+971</span>
                                                                                </li>
                                                                                <li class="iti__country iti__preferred" tabindex="-1" id="iti-0__item-bh-preferred" role="option" data-dial-code="973" data-country-code="bh" aria-selected="false">
                                                                                    <div class="iti__flag-box">
                                                                                        <div class="iti__flag iti__bh"></div>
                                                                                    </div>
                                                                                    <span class="iti__country-name">Bahrain (&#x202B;البحرين&#x202C;&lrm;)</span><span class="iti__dial-code">+973</span>
                                                                                </li>
                                                                                <li class="iti__country iti__preferred" tabindex="-1" id="iti-0__item-om-preferred" role="option" data-dial-code="968" data-country-code="om" aria-selected="false">
                                                                                    <div class="iti__flag-box">
                                                                                        <div class="iti__flag iti__om"></div>
                                                                                    </div>
                                                                                    <span class="iti__country-name">Oman (&#x202B;عُمان&#x202C;&lrm;)</span><span class="iti__dial-code">+968</span>
                                                                                </li>
                                                                                <li class="iti__country iti__preferred" tabindex="-1" id="iti-0__item-kw-preferred" role="option" data-dial-code="965" data-country-code="kw" aria-selected="false">
                                                                                    <div class="iti__flag-box">
                                                                                        <div class="iti__flag iti__kw"></div>
                                                                                    </div>
                                                                                    <span class="iti__country-name">Kuwait (&#x202B;الكويت&#x202C;&lrm;)</span><span class="iti__dial-code">+965</span>
                                                                                </li>
                                                                                <li class="iti__country iti__preferred" tabindex="-1" id="iti-0__item-qa-preferred" role="option" data-dial-code="974" data-country-code="qa" aria-selected="false">
                                                                                    <div class="iti__flag-box">
                                                                                        <div class="iti__flag iti__qa"></div>
                                                                                    </div>
                                                                                    <span class="iti__country-name">Qatar (&#x202B;قطر&#x202C;&lrm;)</span><span class="iti__dial-code">+974</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-dz" role="option" data-dial-code="213" data-country-code="dz" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Algeria (&#x202B;الجزائر&#x202C;&lrm;)</span><span class="iti__dial-code">+213</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-km" role="option" data-dial-code="269" data-country-code="km" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Comoros (&#x202B;جزر القمر&#x202C;&lrm;)</span><span class="iti__dial-code">+269</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-eg" role="option" data-dial-code="20" data-country-code="eg" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Egypt (&#x202B;مصر&#x202C;&lrm;)</span><span class="iti__dial-code">+20</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-ir" role="option" data-dial-code="98" data-country-code="ir" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Iran (&#x202B;ایران&#x202C;&lrm;)</span><span class="iti__dial-code">+98</span>
                                                                                </li>
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-iq" role="option" data-dial-code="964" data-country-code="iq" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Iraq (&#x202B;العراق&#x202C;&lrm;)</span><span class="iti__dial-code">+964</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-il" role="option" data-dial-code="972" data-country-code="il" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Israel (&#x202B;ישראל&#x202C;&lrm;)</span><span class="iti__dial-code">+972</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-jo" role="option" data-dial-code="962" data-country-code="jo" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Jordan (&#x202B;الأردن&#x202C;&lrm;)</span><span class="iti__dial-code">+962</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-lb" role="option" data-dial-code="961" data-country-code="lb" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Lebanon (&#x202B;لبنان&#x202C;&lrm;)</span><span class="iti__dial-code">+961</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-ly" role="option" data-dial-code="218" data-country-code="ly" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Libya (&#x202B;ليبيا&#x202C;&lrm;)</span><span class="iti__dial-code">+218</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-mk" role="option" data-dial-code="389" data-country-code="mk" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">North Macedonia (Македонија)</span><span class="iti__dial-code">+389</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-mr" role="option" data-dial-code="222" data-country-code="mr" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Mauritania (&#x202B;موريتانيا&#x202C;&lrm;)</span><span class="iti__dial-code">+222</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-ma" role="option" data-dial-code="212" data-country-code="ma" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Morocco (&#x202B;المغرب&#x202C;&lrm;)</span><span class="iti__dial-code">+212</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-pk" role="option" data-dial-code="92" data-country-code="pk" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Pakistan (&#x202B;پاکستان&#x202C;&lrm;)</span><span class="iti__dial-code">+92</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-ps" role="option" data-dial-code="970" data-country-code="ps" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Palestine (&#x202B;فلسطين&#x202C;&lrm;)</span><span class="iti__dial-code">+970</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-ss" role="option" data-dial-code="211" data-country-code="ss" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">South Sudan (&#x202B;جنوب السودان&#x202C;&lrm;)</span><span class="iti__dial-code">+211</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-lk" role="option" data-dial-code="94" data-country-code="lk" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Sri Lanka (ශ්&zwj;රී ලංකාව)</span><span class="iti__dial-code">+94</span>
                                                                                </li>
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-sd" role="option" data-dial-code="249" data-country-code="sd" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Sudan (&#x202B;السودان&#x202C;&lrm;)</span><span class="iti__dial-code">+249</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-sy" role="option" data-dial-code="963" data-country-code="sy" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Syria (&#x202B;سوريا&#x202C;&lrm;)</span><span class="iti__dial-code">+963</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-tn" role="option" data-dial-code="216" data-country-code="tn" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Tunisia (&#x202B;تونس&#x202C;&lrm;)</span><span class="iti__dial-code">+216</span>
                                                                                </li>
                                                                                ...
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-eh" role="option" data-dial-code="212" data-country-code="eh" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Western Sahara (&#x202B;الصحراء الغربية&#x202C;&lrm;)</span><span class="iti__dial-code">+212</span>
                                                                                </li>
                                                                                <li class="iti__country iti__standard" tabindex="-1" id="iti-0__item-ye" role="option" data-dial-code="967" data-country-code="ye" aria-selected="false">
                                                                                    ...
                                                                                    <span class="iti__country-name">Yemen (&#x202B;اليمن&#x202C;&lrm;)</span><span class="iti__dial-code">+967</span>
                                                                                </li>
                                                                        ...
                                                                        <input type="tel" class="iti__input form-control" id="phone" data-validate-intl-phone="" data-intl-phone="" data-intl-preferred="AE,BH,OM,KW,QA,SA" value="" maxlength="20" autocomplete="tel" aria-describedby="phoneValidation-dwfrm_shipping_shippingAddress_addressFields_phone" required="" placeholder="50 123 4567" data-intl-tel-input-id="0" style="padding-left: 92px;" name="phone_no">
                                                                    </div>
                                                                    ...
                                                                    <div id="dwfrm_shipping_shippingAddress_addressFields_phone-1666151536453" class="invalid-feedback"></div>
                                                                </div>
                                                        ...
                                                        <div id="dwfrm_shipping_shippingAddress_addressFields_usingVerifiedAddress-333526276577" class="invalid-feedback"></div>
                                                    </div>
                                                </fieldset>
                                                ...
                                                <fieldset class="checkout-stage__details-section--no-spacing" data-checkout-component="shipping-methods-section">
                                                    ...
                                                    <div class="cms-generic-copy form-intro__copy text-line--medium">
                                                        ...
                                                        <div class="content-asset">
                                                            ...
                                                            <p class="flex">
                                                                <svg class="icon icon--large icon--set-left-short" viewBox="0 0 26 26">
                                                                    <circle cx="12" cy="8" r="1.2"></circle>
                                                                    <path d="M13 11c0-.6-.4-1-1-1h-2v2h1v3H9v2h6v-2h-2v-4z"></path>
                                                                ...
                                                                <span class="set--w-100">Working days are Monday to Friday, excluding public holidays.</span>
                                                            </p>
                                                    ...
                                                    <div class="form-check-list" data-select-shipping-method-url="" data-action-url="" data-checkout-component="shipping-method-list">
                                                        ...
                                                        <div class="shipping-method__item row" style="display: none">
                                                            <div class="col-8 col-md-9">
                                                                <div class="form-check">
                                                                    ...
                                                                    <div id="dwfrm_shipping_shippingAddress_shippingMethodID-103809467635" class="invalid-feedback"></div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="shipping-method__item row">
                                                            <div class="col-8 col-md-9">
                                                                <div class="form-check">
                                                                    ...
                                                                    <div id="shippingMethodRadioButton-1267592559017" class="invalid-feedback"></div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div id="shipmentUUID-146925642301" class="invalid-feedback"></div>
                                                </fieldset>
                                            ...
                                            <div class="checkout-stage__store-locator tab-content__panel" role="tabpanel" data-checkout-component="store-locator-container" id="toggleID-4169--target" aria-labelledby="toggleID-4169">
                                                <fieldset class="checkout-stage__details-section store-locator--store-pickup" data-checkout-component="shipping-pickup-section">
                                                    <div class="pickup-in-store" data-url="" data-checkout-component="pickup-in-store"></div>
                                                        ...
                                                        <div class="store-details--short">
                                                            ...
                                                            <address class="">
                                                                ...
                                                                <p><span data-address-summary="city"></span>,
                                                                    <span data-address-summary="stateCode"></span>
                                                                    <span data-address-summary="postalCode"></span>
                                                                </p>
                                                            </address>
                                                        </div>
            ...
            <div class="col-12 col-md-5 col-xl-4 off-xl-1">
                ...
                <div class="fixit-container flex-grow-1 gutter--small-only-normal">
                    ...
                    <div class="order-summary gutter--small-up-normal fixit-element fixit--respond-to-parent" style="margin-top:15px">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="product-line-item__attributes font-family--serif body-type--deci word-break--break-word hyphens--auto">
                                                    ...
                                                    <p class="product-line-item__attribute" data-line-item-component="size">
                                                        ...
                                                        <span class="product-line-item__attribute-value">16</span>
                                                    </p>
                                                    <p class="product-line-item__attribute" data-line-item-component="size">
                                                        ...
                                                        <span class="product-line-item__attribute-value">{{$details['quantity']}}</span>
                                                    </p>
