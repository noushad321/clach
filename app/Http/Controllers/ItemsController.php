...
class ItemsController extends Controller
{
    ...
    public function index($category, $subCategory = null, $subCategoryType = null)
    {
        ...
        if (isset($subCategoryType)) {
            ...
            $sub_category = (new SubCategory)->where('slug', $subCategory)->first();
            $products = Product::with('multimedia', 'attributeValues.attribute', 'tags', 'subCategoryType.subCategory.category')->where('fk_sub_category_id', $sub_category->id)->where('fk_sub_category_type_id', $category->id)->get();
        }
